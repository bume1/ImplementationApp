...
const NOTIFICATION_POLL_INTERVAL_SECONDS = parseInt(process.env.NOTIFICATION_POLL_INTERVAL_SECONDS || '3600', 10); // 1 hour default
const NOTIFICATION_REMINDER_DAYS_BEFORE = parseInt(process.env.NOTIFICATION_REMINDER_DAYS_BEFORE || '3', 10);
const NOTIFICATION_LOG_MAX_ENTRIES = parseInt(process.env.NOTIFICATION_LOG_MAX_ENTRIES || '1000', 10);
const WELCOME_CALL_REMINDER_HOURS = (process.env.WELCOME_CALL_REMINDER_HOURS || '24,1').split(',').map(s => parseInt(s.trim(), 10));
...
module.exports = {
  ...
  NOTIFICATION_REMINDER_DAYS_BEFORE,
  NOTIFICATION_LOG_MAX_ENTRIES,
  WELCOME_CALL_REMINDER_HOURS,
  // HubSpot
